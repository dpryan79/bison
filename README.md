...
###DMAP
DMAP directly processes SAM files generated by bison. If you've run
bison_markduplicates, then simply:

    samtools view -hF 0x400 sample.dedup.bam > sample.sam

"sample.sam" can then be processed by DMAP. If you don't intend to mark duplicates, then simply
